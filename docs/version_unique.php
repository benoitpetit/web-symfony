...
final class Version20181214085539 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE order_line (id INT AUTO_INCREMENT NOT NULL, orders_id_id INT NOT NULL, product_id INT NOT NULL, product_color_id INT NOT NULL, product_logo_id INT NOT NULL, product_size_id INT NOT NULL, product_gender_id INT NOT NULL, quantity INT NOT NULL, price_unit_ht DOUBLE PRECISION NOT NULL, promo_unit_ht DOUBLE PRECISION DEFAULT NULL, rate_id INT NOT NULL, price_total_ttc DOUBLE PRECISION NOT NULL, created_date DATETIME NOT NULL, INDEX IDX_9CE58EE1FCDAEAAA (order_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
